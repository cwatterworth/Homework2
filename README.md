...
```bash
cookiecutter gh:cwatterworth/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named Homework2, then do;

```bash
git remote add origin git@github.com:cwatterworth/Homework2.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── Homework2	<- Your notebooks and scripts will live in the main project folder
